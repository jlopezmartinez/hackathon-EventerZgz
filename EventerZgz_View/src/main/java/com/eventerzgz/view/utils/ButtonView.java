...
public class ButtonView extends Button {
    ...
    public ButtonView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.ButtonView_rippleColor,
                mRippleColor);
        mAlphaFactor = a.getFloat(R.styleable.ButtonView_alphaFactor,
                mAlphaFactor);
        mHover = a.getBoolean(R.styleable.ButtonView_hover, mHover);
        a.recycle();
    }
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(ButtonView.this, 1);
                    mIsAnimating = false;
                }
